(ns sicp-clojure.exercises.2-43
	(:require [sicp-clojure.exercises.2-42 :refer [empty-board adjoin-position row column safe?]]
		 	  [sicp-clojure.paragraphs.2-2-1 :refer [s-map]]
		 	  [sicp-clojure.paragraphs.2-2-3 :refer [s-flatmap]]))
